...
rodando o projeto
```
git clone git@github.com:olivx/brprev-ch-board.git
pip install pipenv 
pipenv shell
pipenv install -d
make test 
...
```
BOARD_LENGTH  default=20
PLYED_TIMES   default=300
...
* O jogador impulsivo compra qualquer propriedade 

sobre a qual ele parar.
